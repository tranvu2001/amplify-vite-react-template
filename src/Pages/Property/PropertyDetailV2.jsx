...
const PropertyDetail = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (isCreate) {
                res = await PropertyServices.createProperty(basePayload);
            } else {
                if (!property) {
                ...
                console.log(payload);
                res = await PropertyServices.updateProperty(propertyId, payload);
            }
            ...
            if (isCreate) {
                navigate(`/list-properties/${res.data.propertyId}`);
            } else {
                            ...
                            <View flex="1">
                                <TextField
                                    ...
                                    onChange={(e) => {
                                        ...
                                        updateField("price_display", raw === "" ? "" : formatNumber(raw));
                                    }}
                                    onBlur={() => {
                                        if (formData.price !== "" && formData.price !== null && formData.price !== undefined) {
                                            updateField("price_display", formatNumber(formData.price));
                                        }
                                    }}
                                />
